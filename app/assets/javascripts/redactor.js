...
(function($){
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ['formatting','fontsize', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
					'image', 'video', 'file', 'table', 'link', '|',
					'fontcolor', 'backcolor', '|', 'alignleft', 'aligncenter', 'alignright', 'justify', '|',
					'horizontalrule', 'fullscreen'],
			//buttons: ['html', '|','formatting','fontsize', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
			//		'image', 'video', 'file', 'table', 'link', '|',
			//		'fontcolor', 'backcolor', '|', 'alignleft', 'aligncenter', 'alignright', 'justify', '|',
			//		'horizontalrule', 'fullscreen'],
				...
				fontsize:
				{
					...
					dropdown: 
					{
						1:
						{
							title: RLANG.font1,
							exec: 'fontsize',
							className: 'redactor_fontsize_font1'
						},
						2:
						{
							title: RLANG.font2,
							exec: 'fontsize',
							className: 'redactor_fontsize_font2'
						},
						3:
						{
							title: RLANG.font3,
							exec: 'fontsize',
							className: 'redactor_fontsize_font3'
						},
						4:
						{
							title: RLANG.font4,
							exec: 'fontsize',
							className: 'redactor_fontsize_font4'
						},
						5:
						{
							title: RLANG.font5,
							exec: 'fontsize',
							className: 'redactor_fontsize_font5'
						},
						6:
						{
							title: RLANG.font6,
							exec: 'fontsize',
							className: 'redactor_fontsize_font6'
						},
						7:
						{
							title: RLANG.font7,
							exec: 'fontsize',
							className: 'redactor_fontsize_font7'
						}
					}
				},
				bold:
	...
	Redactor.prototype = {
		...
		execCommand: function(cmd, param)
		{
			if (this.opts.visual && this.doc)
			{
				try
				{
					...
					if(cmd === 'fontsize'){
						jQuery("font[size]", this.doc).removeAttr("size").css("font-size", FSIZE[param]);
					}
		...
		buildResizer: function()
		{
			...
			this.$resizer = $('<div class="redactor_resizer">&equiv;</div>');
